// pages/consultation-mediate/consultation-mediate.js
...
Page({
  ...
  data: {
    ...
    timeNum: 0,
    tabArr: [
      { name: '咨询问题', url: '', code: '', width: 'calc(100% / 2)', active: '' },
      { name: '咨询时间', url: '', code: '', width: 'calc(100% / 2)', active: '' }
    ],
    addNewNum: 0,
    listArr: [
  ...
  getListArr () {
    ...
    const that = this
    wx.request({
      url: app.globalData.$ctx + '/wechatMini/mbmCounselSearch',
      dataType: 'json',
      method: 'GET',
      data: {
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: app.globalData.$ctx + '/wechatMini/mbmCounselSearchCondition',
      dataType: 'json',
      success: function (json) {
