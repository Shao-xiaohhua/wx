// pages/oral-applied/oral-applied.js
const app = getApp();
Page({
                    ...
                    success: function (res) {
                        if (res.data) {
                            ...
                            if (data.code == 1) {
                                ...
                                let infos = wx.getStorageSync("kttj_step3_info_people2");
                                if (data.name) {
                                ...
                                wx.setStorageSync("kttj_step3_info_people2", infos);
                                _this.setData({
                                    inputArr: inputArr
                                })
                            } else {
    ...
    onLoad: function (options) {
        console.log("口头调解：oral-applied");
        let infos = wx.getStorageSync("kttj_step3_info_people2");
        if (!infos) {
            wx.setStorageSync("kttj_step3_info_people2", {});
        } else {
            let inputArr = this.data.inputArr;
    ...
    goNext() {
        const _this = this;
        let params = wx.getStorageSync("kttj_step3_info_people2");
