...
Page({
  ...
  categoryTap: function (e) {
    var id = e.currentTarget.id, win = e.currentTarget.dataset.typewin, tname = e.currentTarget.dataset.typename, tcode = e.currentTarget.dataset.typecode, list = this.data.list;
